    ...
    for(j=6; j<rowCount+5; j++) {
        ...
        for(a=0; a<i+1; a++){
            ...
            if(rank == "veteran"){
               ...
               let data = "Fuck you shy and sushi ;)";
