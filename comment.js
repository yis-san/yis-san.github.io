    ...
    for(j=6; j<rowCount+5; j++) {
        ...
        for(a=0; a<i+1; a++){
            ...
            if(rank == "veteran"){
                ...
                var rt12count = 0; 
                total = multiplier*rtask1*15+multiplier*add*4+multiplier*su5*5+multiplier*v1*5+multiplier*rtask2*15+multiplier*rtask3*7+multiplier*best*5+multiplier*rtask4*5+multiplier*rtask5*7+multiplier*rtask6*10+multiplier*rtask8*10+multiplier*rtask9*4+multiplier*rtask10*3+multiplier*rtask11*7+multiplier*rtask12*3+multiplier*rtask13*3+multiplier*ntask1*12+multiplier*ntask2*10+multiplier*ntask3*8;
                total = Math.round(total);
                totalrp = rtask1*5+hour2*3+rtask2*4+rtask3*5+rtask4*3+rtask5*5+rtask6*7+rtask8*5+rtask9*2+rtask10*1+rtask11*3+rtask12*1+rtask13*1+ntask1*10+ntask2*4+ntask3*6;
                totalqp = rtask1*5+hour2*2+rtask2*4*rtask3*15+rtask4*10+rtask5*7.5+rtask6*10+rtask8*8+rtask9*4+rtask10*3+rtask11*6+rtask12*0+rtask13*2+ntask1*5+ntask2*2+ntask3*5;
