...
function submit(){
    ...
    for(j=2; j<rowCount+1; j++) {
        ...
        if(rank == "captain" || rank == "lieutenant" || rank == "veteran") {
            total = 1.5*rtask1*3+1.5*rtask2*5+1.5*rtask3*5+1.5*su5*5+1.5*add*3+1.5*v1*5+1.5*rtask4*15+1.5*1.5*rtask5*5+1.5*best*5+1.5*rtask5n*3+1.5*rtask6*4+1.5*rtask7*7+1.5*rtask8*15+1.5*ntask1*12+1.5*ntask2*10+1.5*ntask3*8+1.5*ntask4*4;
            ...
            total = rtask1*3+rtask2*5+rtask3*5+su5*5+add*3+v1*5+rtask4*15+1.5*rtask5*5+best*5+rtask5n*3+rtask6*4+rtask7*7+rtask8*15+ntask1*12+ntask2*10+ntask3*8+ntask4*4;
            ...
            if(rtask1>0) rt1 = rtask1*3; else{ } if(rtask2>0) rt2 = rtask2*5; else{ } if(rtask3>0) rt3 = rtask3*5; else{ } if(su5>0) sup5 = su5*5; else{ } if(add>0) addd = add*3; else{ } if(v1>0) v11 = v1*5; else{ } if(rtask4>0) rt4 = rtask4*15; else{ } if(rtask5>0) rt5 = 1.5*rtask5*5; else{ } if(best>0) besti = best*5; else{ } if(rtask5n>0) rt5n = rtask5n*3; else{ } if(rtask6>0) rt6 = rtask6*4; else{ } if(rtask7>0) rt7 = rtask7*7; else{ } if(rtask8>0) rt8 = rtask8*15; else{ } if(ntask1>0) nt1 = ntask1*12; else{ } if(ntask2>0) nt2 = ntask2*10; else{ } if(ntask3>0) nt3 = ntask3*8; else{ } if(ntask4>0) nt4 = ntask4*4; else{ }
        }
        ...
        localStorage.setItem(j, data);
            ...
            const sFileName = 'Task of the week: rtask5.txt';
