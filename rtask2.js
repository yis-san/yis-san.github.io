...
function submit(){
    ...
    for(j=2; j<rowCount+1; j++) {
        ...
        if(rank == "captain" || rank == "lieutenant" || rank == "veteran" || rank == "Captain" || rank == "Lieutenant" || rank == "Veteran") {
            total = 1.5*rtask1*3+1.5*1.5*rtask2*5+1.5*rtask3*5+1.5*su5*5+1.5*add*3+1.5*v1*5+1.5*rtask4*15+1.5*rtask5*5+1.5*best*5+1.5*rtask5n*3+1.5*rtask6*4+1.5*rtask7*7+1.5*rtask8*15+1.5*ntask1*12+1.5*ntask2*10+1.5*ntask3*8+1.5*ntask4*4;
        ...
        localStorage.setItem(j, data);
            ...
            const sFileName = 'Task of the week: rtask2.txt';
